 ...
 */
const addOrUpdateOwner_stg = v2.https.onRequest(async (req, res) => {
 ...
 * */
const addReservation_stg = v2.https.onRequest(async (req, res) => {
    cors(req, res, async () => {
        try {
...
const getReservationsSent_stg = v2.https.onRequest(async (req, res) => {
    cors(req, res, async () => {
        try {
...
module.exports = {addOrUpdateOwner_stg, getNonOwnerUsers_stg, addReservation_stg, getReservationsSent_stg};
